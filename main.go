...
func main() {
    ...
    flag.StringVar(&filterDBName, "dbname", "all|dbname", "SQL type to filter (default 'all')")
    flag.Parse()
    ...
    case "replay":
        ReplaySQL(dbConnStr, slowOutputPath, replayOutputFilePath, filterUsername, filterSQLType, filterDBName)
    case "load":
