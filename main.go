...
var version = "0.3.5-beta, build date 20250620"

var showVersion bool

func main() {
    var mode string
    flag.StringVar(&mode, "mode", "", "Mode of operation: parsemysqlslow ,parsetidbslow ,parsemariadbslow , replay, load, report")
    ...
    case "parsemariadbslow":
        ParseMariaDBLogs(slowLogPath, slowOutputPath)
    case "replay":
...
func printUsage() {
    ...
    fmt.Println("    1.1. parse mysql slow log: ./sql-replay -mode parsemysqlslow -slow-in <path_to_slow_query_log> -slow-out <path_to_slow_output_file>")
    fmt.Println("    1.2. parse tidb slow log: ./sql-replay -mode parsetidbslow -slow-in <path_to_slow_query_log> -slow-out <path_to_slow_output_file>")
    fmt.Println("    1.3. parse mariadb slow log: ./sql-replay -mode parsemariadbslow -slow-in <path_to_slow_query_log> -slow-out <path_to_slow_output_file>")
    fmt.Println("    2. replay mode: ./sql-replay -mode replay -db <mysql_connection_string> -speed 1.0 -slow-out <slow_output_file> -replay-out <replay_output_file> -username <all|username> -sqltype <all|select> -dbname <all|dbname> -ignoredigests <digest1,digest2...> -lang <en|zh>")
